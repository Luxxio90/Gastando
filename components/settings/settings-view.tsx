    ...
    <div className="max-w-lg space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button size="sm" onClick={() => { setForm(emptyForm); setDialogOpen(true) }} className="bg-emerald-600 hover:bg-emerald-700 h-8">
            ...
            <div className="space-y-1">
              {expenses.map(c => (
                <div key={c.id} className="flex items-center justify-between py-1.5 px-2 rounded-lg hover:bg-gray-50">
                  ...
                  {!c.is_default && (
                    <button onClick={() => handleDeleteCategory(c.id)} className="p-1 text-gray-300 hover:text-red-500 transition-colors">
